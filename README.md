...
This repo has been updated to use the new url writeback feature instead of the plugin. https://hitchhikers.yext.com/docs/pages/url-writebacks/ for more info.
