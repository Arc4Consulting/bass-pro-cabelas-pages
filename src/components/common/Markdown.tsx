import { Link, LinkType, Map } from "@yext/pages-components";
      ...
      options={{
        overrides: {
          a: {
            props: {
              id: "",
              className: "underline hover:no-underline text-brand-link-blue",
            },
          },
          ...
          ol: {
            props: { id: "", className: "mb-3 list-decimal list-inside ml-2" },
          },
          ul: {
            props: { id: "", className: "mb-3 list-disc list-inside ml-2" },
          },
