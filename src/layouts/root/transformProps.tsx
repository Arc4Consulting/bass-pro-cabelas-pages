 ...
 * exported function.
 */
export const transformPropsBasspro: TransformProps<
...
> = async (data) => {
  ...
  return {
    ...
    document: {
      ...data.document,
      dm_directoryParents_bassprodirectory: [{ name: name, slug: "" }],
    },
    translations,
  };
};

export const transformPropsCabelas: TransformProps<
  TemplateRenderProps<DirectoryProfile<never>>
> = async (data) => {
  const { name } = data.document;
  ...
  return {
    ...
    document: {
      ...data.document,
      dm_directoryParents_cabelasdirectory: [{ name: name, slug: "" }],
    },
    translations,
  };
};
